...
const menuProile = (
    <Menu>
      <Menu.Item key="0">
        <Link style={style} to="/profile">Take Phote</Link>
      </Menu.Item>
      <Menu.Item key="1">
        <Link style={style} to="/">Upload Photo</Link>
      </Menu.Item>
      <Menu.Item key="2">
        <Link style={style} to="/">Remove Photo</Link>
      </Menu.Item>
    </Menu>
  );
...
const menu = (
  <Menu>
    <Menu.Item key="0">
      <Link style={style} to="/profile"><UserOutlined /> Profile</Link>
    </Menu.Item>
    <Menu.Item key="1">
      <Link style={style}  onClick={() => logOut()} to="/">Sign Out</Link>
    </Menu.Item>
  </Menu>
);
  return (
